                  ...
                  assertions = [
                    {
                      ...
                      message = "galaxy.lukasl-dev.yam requires virtualisation.docker.enable = true.";
                    }
                    {
                      assertion = config.virtualisation.oci-containers.backend == "docker";
                      message = "galaxy.lukasl-dev.yam requires virtualisation.oci-containers.backend = \"docker\".";
                    }
                  ];
