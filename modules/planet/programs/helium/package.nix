...
let
  inherit (lib.importJSON ./version.json) version releases;
...
stdenvNoCC.mkDerivation {
  ...
  postPatch = ''
    substituteInPlace helium-wrapper \
      --replace-fail 'CHROME_VERSION_EXTRA="custom"' \
      'CHROME_VERSION_EXTRA="NixOS"'
  '';
